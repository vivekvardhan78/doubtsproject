...
export const StudentDashboard: React.FC = () => {
  ...
  const loadDoubts = async () => {
    ...
    setLoading(true);
    try {
      const data = await doubtsApi.getMyDoubts(profile.id);
      setDoubts(data);
    } catch (error) {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">My Doubts</h2>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-500">
                    <span className="flex items-center">
                      ...
                      {doubt.is_anonymous ? 'Anonymous' : profile?.full_name}
                    </span>
